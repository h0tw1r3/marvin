...
from marvin.libs.aws.signv4 import (
    AwsCredentials,
    AwsDate,
    AwsURL,
    AwsHeaders,
...
from marvin.libs.crypto.sha import sha256_hex
...
def fixed_date(monkeypatch: pytest.MonkeyPatch) -> AwsDate:
    ...
    monkeypatch.setattr("marvin.libs.aws.signv4.datetime", FixedDatetime)
...
def test_sign_aws_v4_basic(monkeypatch: pytest.MonkeyPatch):
    ...
    # Fix date
    monkeypatch.setattr(
        "marvin.libs.aws.signv4.build_aws_date",
