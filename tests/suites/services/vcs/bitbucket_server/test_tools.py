from marvin.clients.bitbucket_server.pr.schema.activities import BitbucketServerActivitySchema
...
from marvin.clients.bitbucket_server.pr.schema.user import BitbucketServerUserSchema
