...
from marvin.clients.claude.schema import (
    ClaudeUsageSchema,
    ClaudeContentSchema,
    ClaudeChatRequestSchema,
    ClaudeChatResponseSchema,
)
from marvin.clients.claude.types import ClaudeHTTPClientProtocol
from marvin.config import settings
from marvin.libs.config.llm.base import ClaudeLLMConfig
from marvin.libs.config.llm.claude import ClaudeMetaConfig, ClaudeHTTPClientConfig
...
def claude_llm_client(
    ...
    monkeypatch.setattr(
        "marvin.services.llm.claude.client.get_claude_http_client",
