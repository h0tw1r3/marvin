...
from marvin.clients.gemini.schema import (
    GeminiPartSchema,
    GeminiUsageSchema,
    GeminiContentSchema,
...
from marvin.clients.gemini.types import GeminiHTTPClientProtocol
from marvin.config import settings
from marvin.libs.config.llm.base import GeminiLLMConfig
from marvin.libs.config.llm.gemini import GeminiMetaConfig, GeminiHTTPClientConfig
...
def gemini_llm_client(
    ...
    monkeypatch.setattr(
        "marvin.services.llm.gemini.client.get_gemini_http_client",
