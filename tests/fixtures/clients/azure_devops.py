...
from marvin.clients.azure_devops.pr.schema.pull_request import (
...
from marvin.clients.azure_devops.pr.schema.user import AzureDevOpsUserSchema
...
from marvin.libs.config.vcs.base import AzureDevOpsVCSConfig
...
def azure_devops_vcs_client(
    ...
    monkeypatch.setattr(
        "marvin.services.vcs.azure_devops.client.get_azure_devops_http_client",
