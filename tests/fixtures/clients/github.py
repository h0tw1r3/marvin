...
from marvin.clients.github.pr.schema.comments import (
...
from marvin.clients.github.pr.schema.files import GitHubGetPRFilesResponseSchema, GitHubPRFileSchema
from marvin.clients.github.pr.schema.pull_request import (
    GitHubUserSchema,
    GitHubLabelSchema,
    GitHubBranchSchema,
    GitHubGetPRResponseSchema,
)
from marvin.clients.github.pr.types import GitHubPullRequestsHTTPClientProtocol
from marvin.config import settings
from marvin.libs.config.vcs.base import GitHubVCSConfig
...
def github_vcs_client(
    ...
    monkeypatch.setattr(
        "marvin.services.vcs.github.client.get_github_http_client",
