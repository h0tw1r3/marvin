...
from marvin.clients.bitbucket_server.pr.schema.pull_request import (
...
from marvin.libs.config.vcs.base import BitbucketServerVCSConfig
from marvin.libs.config.vcs.bitbucket_server import BitbucketServerPipelineConfig, BitbucketServerHTTPClientConfig
...
def bitbucket_server_vcs_client(
    ...
    monkeypatch.setattr(
        "marvin.services.vcs.bitbucket_server.client.get_bitbucket_server_http_client",
