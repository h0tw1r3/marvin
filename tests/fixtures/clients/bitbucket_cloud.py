...
from marvin.clients.bitbucket_cloud.pr.schema.pull_request import (
...
from marvin.libs.config.vcs.base import BitbucketCloudVCSConfig
...
def bitbucket_cloud_vcs_client(
    ...
    monkeypatch.setattr(
        "marvin.services.vcs.bitbucket_cloud.client.get_bitbucket_cloud_http_client",
