...
from marvin.clients.gitea.pr.schema.pull_request import (
...
from marvin.libs.config.vcs.base import GiteaVCSConfig
...
def gitea_vcs_client(
    ...
    monkeypatch.setattr(
        "marvin.services.vcs.gitea.client.get_gitea_http_client",
