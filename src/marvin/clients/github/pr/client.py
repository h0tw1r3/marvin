...
from marvin.clients.github.pr.schema.files import (
    GitHubPRFileSchema,
    GitHubGetPRFilesQuerySchema,
    GitHubGetPRFilesResponseSchema
)
from marvin.clients.github.pr.schema.pull_request import GitHubGetPRResponseSchema
from marvin.clients.github.pr.types import GitHubPullRequestsHTTPClientProtocol
from marvin.clients.github.tools import github_has_next_page
