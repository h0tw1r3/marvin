...
from marvin.clients.gitlab.mr.schema.changes import GitLabGetMRChangesResponseSchema
from marvin.clients.gitlab.mr.schema.discussions import (
...
from marvin.clients.gitlab.mr.schema.notes import (
    GitLabNoteSchema,
...
from marvin.clients.gitlab.mr.types import GitLabMergeRequestsHTTPClientProtocol
from marvin.clients.gitlab.tools import gitlab_has_next_page
