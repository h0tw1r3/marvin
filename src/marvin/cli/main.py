...
from marvin.cli.commands.run_clear_inline_review import run_clear_inline_review
from marvin.cli.commands.run_clear_summary_review import run_clear_summary_review
from marvin.cli.commands.run_context_review import run_context_review_command
from marvin.cli.commands.run_inline_reply_review import run_inline_reply_review_command
from marvin.cli.commands.run_inline_review import run_inline_review_command
from marvin.cli.commands.run_review import run_review_command
from marvin.cli.commands.run_summary_reply_review import run_summary_reply_review_command
...
def show_config():
    ...
    typer.secho("Loaded marvin configuration:", fg=typer.colors.CYAN, bold=True)
