from marvin.clients.azure_devops.client import get_azure_devops_http_client
...
from marvin.services.vcs.azure_devops.adapter import get_review_comment_from_azure_devops_comment
